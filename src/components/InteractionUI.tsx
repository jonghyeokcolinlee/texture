...
export const InteractionUI: React.FC<InteractionUIProps> = ({ title, isPlaying, onTogglePlay }) => {
    ...
    return (
        <div className="absolute top-0 left-0 w-full px-4 md:p-6 lg:p-10 z-50 pointer-events-none select-none">
            <div className="mt-4 md:mt-2 text-[20px] lg:text-[24px] tracking-[-0.03em] leading-[1.1] font-medium text-black flex flex-col">
                <div className="flex items-start w-full py-1">
                    <span className="w-[1.8em] shrink-0 text-left"></span>
